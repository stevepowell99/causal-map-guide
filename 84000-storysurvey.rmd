...
This table can be (re-)constructed with the function generate_embeddings() (there is a button in the Cluster panel). This should not be necessary as the embedding for each new phrase is added to the table `ss2embeddings` when the respondent enters it.

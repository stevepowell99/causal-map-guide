...
Quickfields are a special kind of [flag](#xflags) for factors and links. They are a *refinement* of flags for when you have a set of categories which is mutually exclusive.

...
You don't need to read all the levels! Most people will want to read and do the quiz for Level 1. 

Then, if you just want to do some basic analysis, read Level 2.

Or, if you just want to do some basic coding, read Level 3.

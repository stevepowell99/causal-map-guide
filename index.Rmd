...
This Guide accompanies the new version of Causal Map and is valid from September 2021. 

The [old version of this Guide](http://guide2.causalmap.app.s3-website.eu-west-2.amazonaws.com/) covers the old version of Causal Map which is hosted at go.causalmap.app. 

This Guide is in three parts:

1)  Basic causal mapping.

2)  Advanced causal mapping.

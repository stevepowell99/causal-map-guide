# Editing factors and links (1){#xedit-factor-and-links1}
...
You can also edit multiple factors using the [tables](#xedit-factor-and-links1) and the [factor editor tab](#xfactor-editor).

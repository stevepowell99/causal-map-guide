...
On the Tokyo server only, you and your colleagues can log in to the same or different maps from the same or different accounts^[depending on your subscription status], including from multiple browser tabs -- so you can have two maps open at once.

*Now, two different people can edit the same file at the same time* (or you can even have the same file open yourself in two different browser tabs if you want). If the file was edited elsewhere since you last (re)loaded it, when making changes you will see a notification that your changes will be merged, but everything should just work, for example:

...
As well as exporting your map as a png or svg from the maps in the Code & View tab, in the `Download` tab you can always export all your data in different formats:
...
## The Upload and Fix tab: uploading/importing and tweaking your data

The documentation is work in progress. 

### Uploading/importing statements and additional data as one file
...
#### Preparing and uploading/importing your .csv file
...
### Uploading/importing additional statements ("appending statements")

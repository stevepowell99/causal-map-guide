...
- You can import a standard-format Excel file into cm2, and download it again, and edit it, and upload it again ("round-tripping"). We managed to do this with Becky's Mozambique file. You can also include any 

  additional fields

   aka columns you want and they will be imported and available for searching, conditional formatting etc. I think this is a pretty big deal and should (eventually) mean that people can play around and reimport their own data without having to bother us for help.

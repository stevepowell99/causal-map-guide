...
Quickfields can be hidden in labels using the `hide_quickfields` filter, to go from this:

![image-20220124103710109](_assets/image-20220124103710109.png)

to this:

![image-20220124103637546](_assets/image-20220124103637546.png)

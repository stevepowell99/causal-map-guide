...
<details><summary>When I use literal labels on my links e.g. to list all the sources like "AM1; AM3; AM5", I can't use `wrap links` to wrap the link labels and insert line breaks, I just get some very long labels.</summary>
This is just the way the Causal Map functions work, we will fix it sometime, sorry.</details>

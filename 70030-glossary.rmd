...
| **Shortlink** | A weblink (URL) to a causal map which has been shortened, usually to make sharing it easier. You can easily make [shortlinks](#xsharing_view) using the dashboard. |

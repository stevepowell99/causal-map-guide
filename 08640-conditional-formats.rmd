...
🧪 The default discrete palette is https://colorbrewer2.org/#type=qualitative&scheme=Set1&n=9, but you can change the palette number like this:
...
or just
```
color links value = literal:#area pal=6
```

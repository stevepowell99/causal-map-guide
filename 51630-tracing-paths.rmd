# 📚 Tracing paths {#xtracing-paths}

![image-20230128222050923](_assets/image-20230128222050923.png)

## Summary

### How to trace paths{#howtotracepathsandrobustness}
...
![image-20221017080606765](_assets/image-20221017080606765.png)
...
### Removing unwanted links{#xremoving-unwanted-links}
...
![image-20221017080731614](_assets/image-20221017080731614.png)
...
[Read more about tracing paths and tracing threads](#xcontinuity).
...
## Tracing paths and calculating robustness *by field* {#xtracing-paths-by-field}

...
These fields are also available as `has_downstream_threads`, `has_downstream_threads_surviving` etc, but as this filter now works upstream too, we have removed the `downstream` part.

...
If you use `percent` for labels, the label shows just the percentage. 

If you use `proportion` for labels, the label shows the raw number / the baseline. 

If you use `percent` or `proportion` for colour or width of the links, the percentage is used rather than the raw number. 
...
The most interesting filter uses a function which we call `surprise`. Here is an example: [2302](https://causalmap.shinyapps.io/CausalMap2?s=2302).

![image-20220801223501618](_assets/image-20220801223501618.png)

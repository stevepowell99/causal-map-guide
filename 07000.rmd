...
The following examples demonstrate how applying different upstream and downstream step filters affect the causal pathways presented in the map.

**Searching for factor ‘B’**
The default: one step upstream – one step downstream
...
Also, path tracing is the prerequisite for calculating Robustness, [see later](#quantifying-causal-evidence).

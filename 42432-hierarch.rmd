...
If you find yourself wanting to put a factor into more than one hierarchy, try using [quickfields](#xquickfields) or [flags](#xflags) instead.
...
When the analyst wants to group certain factors into a theme (like “health”) which is not itself a causal factor, hierarchical coding should not be used. Instead, text flags like “#Environment” or “[Environment]” or just “Environment” can be used to create themes simply by adding the text flag to the factor label, e.g. 
...
You can use flags in parallel with hierarchies:

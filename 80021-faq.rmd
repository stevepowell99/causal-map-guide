...
<!--DO NOT TRY TO EDIT THIS TEXT, EDIT FAQ.TXT INSTEAD--></details>
<details><summary> Can't log in, getting an error about "failed to execute 'setitem' on 'storage'"</summary>
...
<details><summary>How do I import and export maps from Causal Map?</summary>

You can download your map from Causal Map as an Excel file, tweak it and then upload it Causal Map.

</details>
<details><summary>I have done something wrong, how do I know which version of my mapfile to restore?</summary>
...
<details><summary>I made changes to file access with the Files panel to allow my colleague to see my file, but she still can't see it.</summary>

Tell her to refresh her browser and your changes should appear.

</details>
<details><summary>Can I upload data with special characters like emojis, or characters from non-English languages?</summary>
...
<details><summary>When I upload new or updated data into the app, does it matter what the Excel / spreadsheet file is called?</summary>
...
<details><summary>I have over 500 factors and when I try to type a new factor label, the app gets slow.</summary>
...
<details><summary>When should I use a factor hashtag, and when should I use a link hashtag?</summary>
...
<details><summary>I'm all zoomed out, how do I get a normal zoom level in my browser?</summary>
...
<details><summary>How do I link two existing chains?</summary>
...
<details><summary>What do the functions `unique` and `literal` mean when conditionally formatting links?</summary>
...
<details><summary>Depending on the size of the screen, when I go to press one of the tabs like the one with the question icon, the icon then changes position to go to the next level - which I then can't reach. Or the tabs flicker and slide around.</summary>
...
<details><summary>My link label is appearing slightly away from the link</summary>
...
<details><summary>How do I upload my QuIP project into Causal Map?</summary>
...
<details><summary>Where can I find example files to use as templates?</summary>
...
<details><summary>Is there a more cost-effective option to use during the analysis phase of the causal mapping?</summary>
...
<details><summary>If I wanted to put my membership on pause, can I come back and access the coded data and existing maps at any point?</summary>
...
<details><summary>What is the best way to store my coded data?</summary>

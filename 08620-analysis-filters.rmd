...
![image-20210929183453016](_assets/image-20210929183453016.png){width=650}
...
![image-20210929184054292](_assets/image-20210929184054292.png){width=650}
...
![image-20211228115855510](_assets/image-20211228115855510.png){width=650}



One step upstream – zero steps downstream:

![image-20211228115935071](_assets/image-20211228115935071.png){width=650}



This analysis function is particularly useful for searching for important factors such as intervention activities or intended programme outcomes and can be used in conjunction with [flags](#xflags).
...
![image-20211017203030093](_assets/image-20211017203030093.png){width=650}

![image-20211017203439458](_assets/image-20211017203439458.png){width=650}

![image-20211017203255902](_assets/image-20211017203255902.png){width=650}
...
![image-20211017130102189](_assets/image-20211017130102189.png){width=650}

![image-20211016141204775](_assets/image-20211016141204775.png){width=650}

This analysis function is a powerful tool which enables you to view full causal pathways and to interrogate the relationships between specific causal factors. See the next section for more information on how to use the [tracing robustness](#xrobustness).
...
![image-20211206170740020](_assets/image-20211206170740020.png){width=650}

...
- Watch how that passage is copied for you into the “Quote” window below. (Usually, you don't need to think about this window: you can edit the text if you really need to but it has to remain an exact quote of one part of the text or you will get a warning.) 
...
Factor names which contain semicolons **;**. get special treatment as they separate the different parts of [hierarchical](#xsimplifying-with-hierarchical) labels.

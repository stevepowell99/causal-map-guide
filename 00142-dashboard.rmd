...
The Dashboard contains filters from shortlinks saved by you or other users.

Any filters specific to the current file are listed first and labelled with a grey "person" icon, followed by standard filters which work on any file and are shown with a ⭐ and a yellow border.

### Actions

Click on a shortlink to load the associated filters into the current file.

- Copy: Copy the link and filter for pasting into a document or sending to someone. 
- Edit: Edit the filter - see below.
...
### The Standard and Custom shortlinks

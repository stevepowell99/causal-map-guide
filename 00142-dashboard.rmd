...
The Dashboard lists views of the current file saved by you or other users. These views save information about the currently applied filters as well as the specific tab you are looking at and, in the case of tables, the way you have set up the table as well. They also save the name of the current fil
...
Recommended views can only be added / edited by admins.  They are not related to specific files but should be applicable to almost any file.  

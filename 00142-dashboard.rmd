...
- **`Copy` icon**: Copy the link and filter for pasting into a document or sending to someone. If you send someone a shortlink to a view, when they click on it they will be taken to the *same view of the current file* (providing you have given them View or Edit rights to the file).

- **`Edit` icon**: Edit the view - see below.

...
There is a [longer version](https://www.causalmap.app/causal-mapping) of this post.



#### Induct

Causal mapping aims to directly understand and collate the causal claims which people make in narrative (and other) data rather than trying deduce causal cohttps://player.vimeo.com/video/580212681nnections using statistics or other methods. It starts with what people actually say in real-world contexts and does not rely on heavily pre-structured question formats. Urgent, unexpected, and unwelcome information is treated at face value.

...
To share a link to a file click the orange arrow on the top panel. You can then add a title for this shortlink, to remind you of its content, but this is optional. The short link will be copied to your clipboard and anyone you send this to will be able to see your map with the current filters applied (providing they have the correct [permissions](#xpermissions)).
...
The above buttons relate to uploading your data, see [this section](#xuploading-and-updating) for more information.

...
🧪 You can now, experimentally, change the size of the Print map by double-clicking on it and/or using the `+` and `-` buttons. You can also drag it around, which is a bit weird ...
